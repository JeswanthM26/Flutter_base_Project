...
//               fontWeight: FontWeight.w500 // As per figma for filled text
//               ),
...
//               ),
//             ),
//             errorBorder: InputBorder.none, // No border for error unless focused
//             focusedErrorBorder: OutlineInputBorder(
//               borderRadius: BorderRadius.circular(inputFieldBorderRadius),
//               borderSide: BorderSide(
//                 color: AppColors.semantic_error(context),
//                 width: 1.5, // Consistent width for error states
//               ),
//             ),
...
//   TextEditingValue formatEditUpdate(
//       TextEditingValue oldValue, TextEditingValue newValue) {
//     // Get the text without any commas
//     String cleanText = newValue.text.replaceAll(',', '');

//     // If the text is empty or just a decimal point, return it as is
...
//     // Choose the formatter based on the format type

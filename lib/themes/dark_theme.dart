...
const Color primary_button_disabled = Color(0x1F000108); // 12% opacity on #000108
...
// const Color primary = Color(0xFF4FA8ED);
// const Color secondary = Color(0xFFB3E0FF);
// const Color button= Color(0xFF000108);
// const Color button_pressed= Color(0xFF000105);
// const Color button_disabled= Color(0x1F000108);
// const Color button_2= Color(0xFFFFFFFF);
// const Color icons= Color(0xFF181818);
// const Color icons_2= Color(0xFFFFFFFF);


// const Color text_button= Color(0xFF0073C0);
// const Color text_primary= Color(0xFF181818);
// const Color text_inverse= Color(0xFFFFFFFF);
// const Color text_secondary= Color(0xFF6D717F);
// const Color test_tertiary= Color(0xFF57778C);
...
// const Color input_field_default= Color(0x14767680);
// const Color input_field_border= Color(0xFF8D8D95);
// const Color input_feld_default_text= Color(0xFFBBBBC0);
